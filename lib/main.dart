...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void initState() {
    ...
    PermissionHandler().requestPermissions(<PermissionGroup>[
      PermissionGroup.storage, // Adicione as permissões necessárias aqui
    ]);
  }
            ...
            children: <Widget>[
              ...
              Container(
                ...
                child: RaisedButton(
                  ...
                  child: Text("Salvar imagem da página na Galeria"),
                ),
                width: 200,
                height: 44,
              ),
              Container(
                ...
                child: RaisedButton(
                  onPressed: _getHttp,
                  child: Text("Salvar fotos da web"),
                ),
                width: 200,
                height: 44,
              ),
              Container(
                ...
                child: RaisedButton(
                  ...
                  child: Text("Salvar vídeos da web"),
                ),
                width: 200,
                height: 44,
              ),
  ...
  _saveScreen() async {
    ...
    print(await ImageGallerySaver.saveImage(byteData.buffer.asUint8List()));
    print(result);
  }
